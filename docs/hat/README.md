...
| US 5 — Search for a specific item | [US5-search-specific-item.md](./US5-search-specific-item.md) |
...
_Add new rows when additional HAT reports land (e.g. US 8). Each `US*.md` file’s header links the GitHub HAT issue and implementing PR._
