...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex w-[220px] shrink-0 flex-col gap-1 border-r border-gray-200 bg-white p-3 sticky top-[58px] h-[calc(100vh-58px)] overflow-y-auto">
